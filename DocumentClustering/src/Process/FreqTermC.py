...
class FreqTermCluster(object):
    ...
    def __init__(self,stopwords, ignorechars, docs, minsup=.3):
        '''
        Constructor
        '''
        self._minsup = minsup
...
#         self.freq_terms = set()
    ...
    def _set_freq_terms(self):
        f_terms = set([term for term in self.vocabulary if 
                        len(self.cov(term)) >= self._minsup * len(self.docs)])
...
#     docs = [title for title in open("/home/netzsooc/Documents/infotec/Investigacion/justTitles.txt")]
